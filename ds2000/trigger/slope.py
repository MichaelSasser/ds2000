...
class SlopeWhen(SubSubController):
    def set_positive_slope_time_greater_than_specified_lower_limit(
        ...
        **Example**
        ...
        """
        self.subsubdevice.subdevice.device.ask(":TRIGger:SLOPe:WHEN PGReater")
    ...
    def set_positive_slope_time_lower_than_specified_upper_limit(self) -> None:
        ...
        **Example**
        ...
        The query returns PGR.
        """
        self.subsubdevice.subdevice.device.ask(":TRIGger:SLOPe:WHEN PLESs")
    ...
    def set_negative_slope_time_greater_than_specified_lower_limit(
        ...
        **Example**
        ...
        The query returns PGR.
        """
        self.subsubdevice.subdevice.device.ask(":TRIGger:SLOPe:WHEN NGReater")
    ...
    def set_negative_slope_time_lower_than_specified_upper_limit(self) -> None:
        ...
        **Example**
        ...
        The query returns PGR.
        """
        self.subsubdevice.subdevice.device.ask(":TRIGger:SLOPe:WHEN NLESs")
    ...
    def set_positive_slope_time_between_specified_lower_and_upper_limit(
        ...
        **Example**
        ...
        The query returns PGR.
        """
        self.subsubdevice.subdevice.device.ask(":TRIGger:SLOPe:WHEN PGLess")
    ...
    def set_negative_slope_time_between_specified_lower_and_upper_limit(
        ...
        **Example**
        ...
        The query returns PGR.
        """
        self.subsubdevice.subdevice.device.ask(":TRIGger:SLOPe:WHEN NGLess")
    ...
    def status(self) -> str:
        ...
        **Example**
        ...
        The query returns PGR.
        """
        return self.subsubdevice.subdevice.device.ask(":TRIGger:SLOPe:WHEN?")
...
class SlopeWindow(SubSubController):
    def set_adjust_upper_limit_of_trigger_level(self) -> None:
        ...
        **Example**
        ...
        """
        self.subsubdevice.subdevice.device.ask(":TRIGger:SLOPe:WINDow TA")
    ...
    def set_adjust_lower_limit_of_trigger_level(self) -> None:
        ...
        **Example**
        ...
        The query returns TB.
        """
        self.subsubdevice.subdevice.device.ask(":TRIGger:SLOPe:WINDow TB")
    ...
    def set_adjust_upper_and_lower_limit_of_trigger_level(self) -> None:
        ...
        **Example**
        ...
        The query returns TB.
        """
        self.subsubdevice.subdevice.device.ask(":TRIGger:SLOPe:WINDow TAB")
    ...
    def status(self) -> str:
        ...
        **Example**
        ...
        The query returns TB.
        """
        return self.subsubdevice.subdevice.device.ask(":TRIGger:SLOPe:WINDow?")
...
class Slope(SubController):
    ...
    def set_source(self, channel: int = 1) -> None:
        ...
        **Example**
        ...
        self.subdevice.device.ask(":TRIGger:SLOPe:SOURce CHANnel{channel}")
    ...
    def get_source(self) -> str:
        ...
        **Example**
        ...
        The query returns CHAN2.
        """
        return self.subdevice.device.ask(":TRIGger:SLOPe:SOURce?")
    ...
    def set_upper_limit(self, time: float = 2.0e-6) -> None:
        ...
        **Example**
        ...
        self.subdevice.device.ask(f":TRIGger:SLOPe:TUPPer {time}")
    ...
    def get_upper_limit(self) -> float:
        ...
        **Example**
        ...
        The query returns 3.000000e-06.
        """
        return float(self.subdevice.device.ask(":TRIGger:SLOPe:TUPPer?"))
    ...
    def get_lower_limit(self) -> float:
        ...
        **Example**
        ...
        The query returns 3.000000e-06.
        """
        return float(self.subdevice.device.ask(":TRIGger:SLOPe:TLOWer?"))
    ...
    def set_upper_limit_trigger_level(self, level: float = 0.0) -> None:
        ...
        **Example**
        ...
        self.subdevice.device.ask(":TRIGger:SLOPe:ALEVel {level}")
    ...
    def get_upper_limit_trigger_level(self) -> float:
        ...
        **Example**
        ...
        The query returns 1.600000e-01.
        """
        return float(self.subdevice.device.ask(":TRIGger:SLOPe:ALEVel?"))
    ...
    def set_lower_limit_trigger_level(self, level: float = 0.0) -> None:
        ...
        **Example**
        ...
        if channel == "CHANnel1":
            ...
            raise RuntimeError("The oscilloscope returned an unknown channel")
        check_level(level, scale, offset)
        self.subdevice.device.ask(f":TRIGger:SLOPe:BLEVel {level}")
    ...
    def get_lower_limit_trigger_level(self) -> float:
        ...
        **Example**
        ...
        The query returns 1.600000e-01.
        """
        return float(self.subdevice.device.ask(":TRIGger:SLOPe:BLEVel?"))
